...
$ctrl_params=[
    ...
    'columns'=>[
        ...
        'state'=>[
            ...
            'control_params'=>[
                'container'=>FALSE,'no_label'=>TRUE,'tag_id'=>'df_template_update_state','value'=>'{!state!}',
                'onchange_ajax_command'=>"{ 'module': '{$this->name}', 'method': 'EditRecordState', 'params': { 'id': '{!id!}', 'state': '{nGet|df_template_update_state_{!id!}:value}' } }",
