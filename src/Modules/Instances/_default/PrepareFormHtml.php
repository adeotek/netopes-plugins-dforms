    ...
    <table
        ...
        if(is_array($relations) && count($relations)) {
            ...
            if(strlen($uid)) {
				...
				<tr>
					<td>
						<label style="<?php echo get_array_value($this->html_styles,'label_style','','is_string'); ?>"><?php echo Translate::GetLabel('form_uid').get_array_value($this->html_styles,'label_value_sep','','is_string'); ?></label><span
								style="<?php echo get_array_value($this->html_styles,'relation_style','','is_string'); ?>"><?php echo $uid; ?></span>
					</td>
				</tr>
                <?php
            }//if(strlen($uid))
            ...
            if(strlen($category)) {
				...
				<tr>
					<td>
						<label style="<?php echo get_array_value($this->html_styles,'label_style','','is_string'); ?>"><?php echo Translate::GetLabel('form_category').get_array_value($this->html_styles,'label_value_sep','','is_string'); ?></label><span
								style="<?php echo get_array_value($this->html_styles,'relation_style','','is_string'); ?>"><?php echo $category; ?></span>
					</td>
				</tr>
                <?php
            }//if(strlen($category))
		...
		<tr>
			<td>
				<label style="<?php echo get_array_value($this->html_styles,'label_style','','is_string'); ?>"><?php echo Translate::GetLabel('created_at').get_array_value($this->html_styles,'label_value_sep','','is_string'); ?></label><span
						style="<?php echo get_array_value($this->html_styles,'relation_style','','is_string'); ?>"><?php echo $create_date; ?></span>
			</td>
		</tr>
		<tr>
			<td>
				<label style="<?php echo get_array_value($this->html_styles,'label_style','','is_string'); ?>"><?php echo Translate::GetLabel('created_by').get_array_value($this->html_styles,'label_value_sep','','is_string'); ?></label><span
						style="<?php echo get_array_value($this->html_styles,'relation_style','','is_string'); ?>"><?php echo $created_by; ?></span>
			</td>
		</tr>
        <?php
        ...
        if(strlen($last_modified)) {
			...
			<tr>
				<td>
					<label style="<?php echo get_array_value($this->html_styles,'label_style','','is_string'); ?>"><?php echo Translate::GetLabel('modified_at').get_array_value($this->html_styles,'label_value_sep','','is_string'); ?></label><span
							style="<?php echo get_array_value($this->html_styles,'relation_style','','is_string'); ?>"><?php echo $last_modified; ?></span>
				</td>
			</tr>
			<tr>
				<td>
		...
		<tr>
            ...
            switch($fClass) {
                case 'FormTitle':
                    ...
                    ?>
					<td>
						<h1 style="text-align: <?php echo $talign.'; '.get_array_value($this->html_styles,'title_style','','is_string'); ?>"><?php echo get_array_value($field,'label',$empty_val,'is_notempty_string'); ?></h1>
					</td>
                    <?php
                    break;
                case 'FormSubTitle':
                    if($css_class=='tacenter') {
                        $talign='center';
                    } elseif($css_class=='taright') {
                        $talign='right';
                    } else {
                    ...
                    ?>
					<td><br/>
						<h3 style="text-align: <?php echo $talign.'; '.get_array_value($this->html_styles,'subtitle_style','','is_string'); ?>"><?php echo get_array_value($field,'label',$empty_val,'is_notempty_string'); ?></h3>
					</td>
                    <?php
                    break;
                case 'FormSeparator':
                ...
                case 'Message':
                    ...
                    ?>
					<td>
						<span style="<?php echo get_array_value($this->html_styles,'msg_style','','is_string'); ?>"><?php echo $flabel.$fdesc; ?></span>
					</td>
                    <?php
                    break;
                case 'SmartComboBox':
                case 'GroupCheckBox':
                    ...
                    ?>
					<td>
						<label style="<?php echo get_array_value($this->html_styles,'label_style','','is_string'); ?>"><?php echo $flabel.get_array_value($this->html_styles,'label_value_sep','','is_string'); ?></label><span
								style="<?php echo get_array_value($this->html_styles,'value_style','','is_string'); ?>"><?php echo $fValue; ?></span>
					</td>
                    <?php
                    break;
                default:
