<?php
	$ctrl_params = array(
		...
		'ds_method'=>'GetValues',
		'ds_params'=>array('for_id'=>NULL,'list_id'=>$id_list,'for_ltype'=>NULL,'for_state'=>NULL,'for_implicit'=>NULL,'for_text'=>NULL),
		'auto_load_data'=>TRUE,
		'columns'=>array(
			'name'=>array(
				'db_field'=>'name',
			...
			'end_actions'=>($edit ? array(
				...
				'actions'=>array(
					array(
						'type'=>'DivButton',
						'command_string'=>"AjaxRequest('Components\DForms\ValuesLists\ValuesLists','ShowValueAddEditForm','id'|{{id}}~'id_list'|{{id_list}},'{$target}')->modal",
					...
					array(
						'type'=>'DivButton',
						'command_string'=>"AjaxRequest('Components\DForms\ValuesLists\ValuesLists','DeleteValueRecord','id'|{{id}}~'id_list'|{{id_list}},'{$target}')->errors",
