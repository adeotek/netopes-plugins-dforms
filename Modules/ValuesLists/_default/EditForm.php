                    ...
                    'content'=>array(
                        ...
                        array(
                            array(
                                ...
                                'control_params'=>array('tagid'=>'df_list_edit_state','tagname'=>'state','value'=>$item->getProperty('state',1,'is_integer'),'label'=>Translate::GetLabel('active'),'class'=>'pull-left'),
                            ),
                        ),
                    ),
                    'actions'=>array(
                        array(
                            'params'=>array('tagid'=>'df_list_edit_save','value'=>Translate::GetButton('save_and_close'),'icon'=>'fa fa-save','onclick'=>NApp::arequest()->Prepare("AjaxRequest('{$this->name}','AddEditRecord','id'|'{$id}'~'close'|0~df_list_edit_form:form,'df_list_edit_form')->df_list_edit_errors")),
                        ),
                        array(
                            'params'=>array('tagid'=>'df_list_edit_save','value'=>Translate::GetButton('save'),'icon'=>'fa fa-save','onclick'=>NApp::arequest()->Prepare("AjaxRequest('{$this->name}','AddEditRecord',,'df_list_edit_form')->df_list_edit_errors")),
                        ),
                    ),
                ),
            ),
