<?php
	$ctrl_params = array(
		...
		'actions'=>array(
			array(
				'params'=>array('tagid'=>'df_list_add_save','value'=>Translate::GetButton('save'),'icon'=>'fa fa-save','onclick'=>NApp::arequest()->Prepare("AjaxRequest('Components\DForms\ValuesLists\ValuesLists','AddEditRecord',df_list_add_form:form,'df_list_add_form')->df_list_add_errors")),
			),
			array(
				'type'=>'CloseModal',
				'params'=>array('tagid'=>'df_list_add_cancel','value'=>Translate::GetButton('cancel'),'icon'=>'fa fa-ban'),
			),
		),
	);
?>