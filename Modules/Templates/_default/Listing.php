...
$ctrl_params = array(
    ...
    'columns'=>array(
        ...
        'state'=>array(
            ...
            'control_params'=>array('container'=>FALSE,'no_label'=>TRUE,'tag_id'=>'df_template_update_state','jqparams'=>'{ type: 5 }','onchange'=>"AjaxRequest('{$this->name}','EditRecordState','id'|'{{id}}'~'state'|df_template_update_state_{{id}}:value)->errors"),
