		...
		'content'=>array(
			...
			array(
				array(
					...
					'control_params'=>array('tag_id'=>'df_template_rel_ae_name','value'=>get_array_value($item,'name','','is_string'),'label'=>Translate::GetLabel('name'),'required'=>TRUE,'onenterbutton'=>'df_template_rel_ae_save'),
				),
			),
			array(
				array(
					'control_type'=>'TextBox',
					'control_params'=>array('tag_id'=>'df_template_rel_ae_key','value'=>get_array_value($item,'key','','is_string'),'label'=>Translate::GetLabel('key'),'required'=>TRUE,'onenterbutton'=>'df_template_rel_ae_save'),
				),
			),
			array(
				array(
			...
			array(
				array(
					...
					'control_params'=>array('tag_id'=>'df_template_rel_ae_required','value'=>get_array_value($item,'required',0,'is_numeric'),'label'=>Translate::GetLabel('required'),'class'=>'pull-left'),
				),
			),
		),
		'actions'=>array(
			array(
				'params'=>array('tag_id'=>'df_template_rel_ae_save','value'=>Translate::GetButton('save'),'icon'=>'fa fa-save','onclick'=>NApp::Ajax()->Prepare("AjaxRequest('{$this->class}','AddEditRelationRecord',
