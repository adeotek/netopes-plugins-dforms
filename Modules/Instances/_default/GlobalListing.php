    ...
    'columns'=>array(
        'actions'=>array(
            ...
            'actions'=>array(
                array(
                    'type'=>'DivButton',
                    'command_string'=>"AjaxRequest('{$this->name}','ShowEditForm','id'|{{id}}~'id_template'|'{{id_template}}'~'cmodule'|'{$this->name}'~'cmethod'|'GlobalListing')->main-content",
                ...
                array(
                    ...
                    'params'=>array('tag_id'=>'df_template_view_btn','tooltip'=>Translate::GetButton('view'),'class'=>NApp::$theme->GetBtnPrymaryClass('btn-xxs pull-right'),'icon'=>'fa fa-eye'),
                ),
            ),
        ),
        'template_code'=>array(
        ...
        'state'=>array(
            ...
            'control_params'=>array('container'=>FALSE,'no_label'=>TRUE,'tag_id'=>'df_instance_update_state','jq_params'=>'{ type: 5 }','onchange'=>"AjaxRequest('{$this->name}','EditRecordState','id'|'{{id}}'~'state'|df_instance_update_state_{{id}}:value)->errors"),
        ...
        'end_actions'=>array(
            ...
            'actions'=>array(
                array(
                    'type'=>'DivButton',
                    'command_string'=>"AjaxRequest('{$this->name}','DeleteRecord','id'|{{id}}~'id_template'|'{{id_template}}'~'cmodule'|'{$this->name}'~'cmethod'|'GlobalListing')->errors",
                    'params'=>array('tag_id'=>'df_instance_delete_btn','tooltip'=>Translate::GetButton('delete'),'class'=>NApp::$theme->GetBtnDangerClass('btn-xxs'),'icon'=>'fa fa-times','confirm_text'=>Translate::GetMessage('confirm_delete'),'conditions'=>array(array('field'=>'ftype','type'=>'!=','value'=>2))),
                ),
            ),
        ),
    ),
