        ...
        switch($fname) {
            ...
            case 'state':
                $ctrl_params['columns']['state'] = array(
                    ...
                    'control_params'=>array('container'=>FALSE,'no_label'=>TRUE,'tagid'=>'df_instance_update_state','jqparams'=>'{ type: 5 }','onchange'=>"AjaxRequest('{$cmodule}','EditRecordState','id'|'{{id}}'~'state'|df_instance_update_state_{{id}}:value)->errors"),
